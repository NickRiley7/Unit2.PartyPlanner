...
async function getGuests() {
  // TODO   1.Fetch 2.parse to json 3.update state(state.guests) 4. get rsvps
}
...
function renderGuests() {
  ...
  // find (filter) rsvps for selected event (state.event)
  //find (filter) guests (state.guest) who have rsvpd (rsvp.guestId)
  // check if array.length > 0, if it is
  // create element <li> with name, email, phone
